...
2. Lock the licence position (BSD-2-Clause upstream; CC BY 4.0 for UniCORE additions).
3. Document the family pattern and upstream relationship in [`README.md`](https://git.unitek-systems.com/UniCORE/UniSaaS.UniCORE.Nginx/src/branch/main/README.md) (mirror: [GitHub](https://github.com/bryanunitek/UniSaaS.UniCORE.Nginx/blob/main/README.md)).
4. Document the merge discipline in [`UPSTREAM-MERGE-DISCIPLINE.md`](https://git.unitek-systems.com/UniCORE/UniSaaS.UniCORE.Nginx/src/branch/main/UPSTREAM-MERGE-DISCIPLINE.md) (mirror: [GitHub](https://github.com/bryanunitek/UniSaaS.UniCORE.Nginx/blob/main/UPSTREAM-MERGE-DISCIPLINE.md)).
