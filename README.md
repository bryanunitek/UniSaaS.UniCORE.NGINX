...
`bryanunitek/UniSaaS.UniCORE.NGINX` is the **NGINX** family member: SaaS-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source reverse proxy + load balancer — multi-node regional balancing for Jitsi and UniCORE.GVB services.

**Deployment shape:** This is the **SaaS-shape** member of the family. It tracks the same upstream codebase as [`UniCORE.NGINX`](https://github.com/bryanunitek/UniCORE.NGINX) (on-prem shape) but carries SaaS-specific configuration, multi-tenant isolation patterns, and cloud-native deployment artefacts.

---

## Upstream

- **Upstream project:** https://github.com/nginx/nginx
...
UniCORE.NGINX is published as a **four-repo family**:

- `bryanunitek/UniCORE.NGINX` — public on-prem-deployment-shape gift surface
- `bryanunitek/UniSaaS.UniCORE.NGINX` — public SaaS-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniCORE.NGINX-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.NGINX-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniSaaS.UniCORE.NGINX/discussions)
